 ...
 * {@link com.mindera.telemetron.client.api.ConfigurationBuilder} as an argument.
 *
...
public final class ConfigurationBuilder<T> {
     ...
     *
     * @param builderChain The {@link com.mindera.telemetron.client.api.ConfigurationBuilderChain} of <code>T</code>.
     */
    ...
    /**
     * Creates a new instance of {@link com.mindera.telemetron.client.api.ConfigurationBuilder} of <code>T</code>.
     *
     * @param <T> The type to return upon build
     * @return An instance of {@link com.mindera.telemetron.client.api.ConfigurationBuilder}
     */
    ...
    /**
     * Creates a new instance of {@link com.mindera.telemetron.client.api.ConfigurationBuilder} with the passed
     * {@link com.mindera.telemetron.client.api.ConfigurationBuilderChain} of <code>T</code>.
     *
     * @param builderChain A {@link com.mindera.telemetron.client.api.ConfigurationBuilderChain} of <code>T</code>
     * @param <T> A T type
     * @return A {@link com.mindera.telemetron.client.api.ConfigurationBuilder} of <code>T</code>
     */
     ...
     *
     * @param tagBuilders An array of {@link com.mindera.telemetron.client.api.TagBuilder} to use, which can be imported statically
     * @return A reference to this configuration builder
     */
     ...
     *
     * @param aggregationBuilders An array of {@link com.mindera.telemetron.client.api.AggregationBuilder} to use, which can be imported statically
     * @return A reference to this configuration builder
     */
     ...
     *
     * @param aggregationFreqBuilder An {@link com.mindera.telemetron.client.api.AggregationFreqBuilder}
     * @return A reference to this configuration builder
     */
    ...
    /**
     * Builds the configuration and passed it to the {@link com.mindera.telemetron.client.api.ConfigurationBuilderChain}
     * of type <code>T</code>.
     *
