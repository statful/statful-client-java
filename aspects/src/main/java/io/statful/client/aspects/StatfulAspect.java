package io.statful.client.aspects;

import io.statful.client.annotations.Timer;
 ...
 * {@link io.statful.client.annotations.Timer} (more to support ), creates a corresponding metric and sends it to
 * Statful client. An instance of a {@link io.statful.client.domain.api.StatfulClient} must be set.
 */
@SuppressFBWarnings(
...
public class StatfulAspect {
     ...
     *
     * @param statful An instance of {@link io.statful.client.domain.api.StatfulClient}
     */
