...
/**
 * This class is an implementation of the {@link io.statful.client.domain.api.SenderAPI},
 * which uses {@link io.statful.client.domain.api.MetricsSender} to send metrics.
 */
