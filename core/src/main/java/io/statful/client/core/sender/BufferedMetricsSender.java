package io.statful.client.core.sender;
...
import io.statful.client.core.message.MessageBuilder;
...
/**
 * This class sends the metrics to Statful using a {@link io.statful.client.core.transport.TransportSender}.
 * And buffers the metrics before sending them, according with
 * {@link io.statful.client.domain.api.ClientConfiguration}.
 * <p>
 * It sends the metrics using {@link io.statful.client.core.transport.TransportSender} in both a periodic way and
 * by checking the number of metrics in the buffer according with the
 * {@link io.statful.client.domain.api.ClientConfiguration} passed in the constructor. The periodic flushes are
...
public class BufferedMetricsSender implements MetricsSender {
     ...
     * Default constructor.
     *
     * @param transportSender The {@link io.statful.client.core.transport.TransportSender} to send metrics
     * @param configuration The {@link io.statful.client.domain.api.ClientConfiguration}
