...
public class DefaultClientConfiguration implements ClientConfiguration {
     ...
     *
     * @param transport The {@link io.statful.client.domain.api.Transport} to use
     */
     ...
     *
     * @param timerAggregationFreq The {@link io.statful.client.domain.api.AggregationFreq} to use
     */
     ...
     *
     * @param aggregation The {@link io.statful.client.domain.api.Aggregation} to merge
     */
     ...
     *
     * @param counterAggregationFreq The {@link io.statful.client.domain.api.AggregationFreq} to use
     */
     ...
     *
     * @param gaugeAggregationFreq The {@link io.statful.client.domain.api.AggregationFreq} to use
     */
