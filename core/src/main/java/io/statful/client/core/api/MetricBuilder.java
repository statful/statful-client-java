...
public final class MetricBuilder {
     ...
     *
     * @param aggregation The {@link io.statful.client.domain.api.Aggregation} to use
     ...
     *
     * @param aggregationFreq The {@link io.statful.client.domain.api.AggregationFreq} to use
