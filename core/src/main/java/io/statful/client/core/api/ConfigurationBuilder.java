...
import io.statful.client.core.config.DefaultClientConfiguration;
...
/**
 * This is a {@link io.statful.client.domain.api.ClientConfiguration} builder which allows to chain a
...
public final class ConfigurationBuilder<T> {
    ...
    /**
     * Returns the {@link io.statful.client.domain.api.ClientConfiguration} to be passed to the
     * {@link ConfigurationBuilderChain}.
     *
     * @return The {@link io.statful.client.domain.api.ClientConfiguration}
     */
